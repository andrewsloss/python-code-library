...
class SavingsAccount(BankAccount):
    ...
    def makeSavingsDeposit(self, dep2):
        if(andrew.balance - dep2 < 0):
            ...
            print("Old Bank Balance = " + str(andrew.balance), end = ", ")
            andrew.makeWithdraw(dep2)
    ...
    def makeSavingsWithdraw(self, wit2):
        if(self.savingsBalance - wit2 < 0):
            ...
            print(f"New Savings Balance = {self.savingsBalance}")
            print("Old Bank Balance = " + str(andrew.balance), end = ", ")
            andrew.makeDeposit(wit2)

andrew = BankAccount("Andrew Sloss", "T0001", 0)
andrewSavings = SavingsAccount(andrew.name, andrew.accountID, andrew.balance, 0)
...
while True:
    ...
    if choice == "1":
        ...
        andrewSavings.makeSavingsDeposit(c)
    elif choice == "4":
        d = int(input("Savings Withdraw Amount: "))
        andrewSavings.makeSavingsWithdraw(d)
    elif choice == "5":
        print("Code Stoped")
        break
    else:
